...
public class Stage12Setting : MonoBehaviour
{
    public GameObject target1, target2, target3;
    Vector3 pos1, pos2, pos3;
    public static int highScore12;
    private string key1 = "HIGH SCORE12";
    // Start is called before the first frame update
    void Start()
    {
        highScore12 = PlayerPrefs.GetInt(key1, 0);
    ...
    void Update()
    {
        ...
        {
            if (ScoreManager.totalscore > highScore12)
            {
                highScore12 = ScoreManager.totalscore;
                PlayerPrefs.SetInt(key1, highScore12);
            }
        }
        if (target1 != null)
        {
