...
public class Stage20Setting : MonoBehaviour
{
    public static int highScore20;
    private string key1 = "HIGH SCORE20";
    public GameObject target1, target2, target3;
    Vector3 pos1, pos2, pos3;
    // Start is called before the first frame update
    void Start()
    {
        highScore20 = PlayerPrefs.GetInt(key1, 0);
    ...
    void Update()
    {
        ...
        {
            if (ScoreManager.totalscore > highScore20)
            {
                highScore20 = ScoreManager.totalscore;
                PlayerPrefs.SetInt(key1, highScore20);
            }
        }
        if (target1 != null)
        {
