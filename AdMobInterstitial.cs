...
public class AdMobInterstitial : MonoBehaviour
{
    ...
    public void ShowAdMobInterstitial()
    {
        ...
        else
        {
            ...
            else if (buttonstate == "stageselect")
            {
...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-3257193068124952/3630464144";//ここにAndroidのインタースティシャル広告IDを入力

#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-3257193068124952/2736460548";//ここにiOSのインタースティシャル広告IDを入力
