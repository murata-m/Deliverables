...
public class Stage26Setting : MonoBehaviour
{
    public static int highScore26;
    private string key1 = "HIGH SCORE26";
    public GameObject target1, target2, target3, pillar, block;
    Vector3 pos1, pos2, pos3;
    // Start is called before the first frame update
    void Start()
    {
        highScore26 = PlayerPrefs.GetInt(key1, 0);
    ...
    void Update()
    {
        if (ScoreManager.totalscore > highScore26)
        {
            highScore26 = ScoreManager.totalscore;
            PlayerPrefs.SetInt(key1, highScore26);
        }
